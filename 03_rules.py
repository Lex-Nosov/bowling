...
from bowling_tournament_new_rules import run

parser = argparse.ArgumentParser()
parser.add_argument('input', type=str, help='Введите имя файла входного файла')
parser.add_argument('output', type=str, help='Введите имя выходного файла')
args = parser.parse_args()

run(tournament=args.input, result_tournament=args.output)
